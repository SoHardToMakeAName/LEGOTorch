...
class Ui_AddLayerWindow(object):
    ...
    def retranslateUi(self, AddLayerWindow):
        ...
        self.layertype.setItemText(9, _translate("AddLayerWindow", "残差连接层(Add)"))
        self.layertype.setItemText(10, _translate("AddLayerWindow", "连接层(Concat2d)"))
        self.layertype.setItemText(11, _translate("AddLayerWindow", "连接层(Concat1d)"))
